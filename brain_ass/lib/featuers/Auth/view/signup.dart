...
import 'package:untitled3/featuers/Auth/view/verfiy.dart';
...
class _SignupState extends State<Signup> {
  ...
  GlobalKey<FormState> nameformcontroler = GlobalKey<FormState>();
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      listener: (context, state) {
        ...
        if (state is RegisterSuccess) {
          ...
          Navigator.pushNamed(context, Verfiy.routeName);
        }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Sign up to start tracking your brain \nhealth",
                    style: GoogleFonts.poppins(
                      fontSize: 16,
                  ...
                  // ================= SIGN UP BUTTON (FIX ONLY) =================
                  Center(
                    child: TextButton(
                      onPressed: () {
                        if (nameformcontroler.currentState!.validate() &&
                            emailformcontroler.currentState!.validate() &&
